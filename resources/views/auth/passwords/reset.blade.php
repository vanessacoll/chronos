         ...
         @csrf
          ...
          <div class="field-group">
            ...
            <div class="wthree-field">
              ...
              <input id="password-confirm" type="password" class="" name="password_confirmation" placeholder="Confirmar Password" required autocomplete="new-password">
          ...
          <div class="wthree-field">
            <button type="submit" class="btn">{{ __('Restablecer la contraseña') }}</button>
          </div>
